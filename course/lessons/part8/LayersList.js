...
import { ArrowDownIcon, ArrowUpIcon } from "sebikostudio-icons";
    ...
    <div className="layersList CanvasSettings darkmode">
      <Flex fluid justify="start" style={{ marginBottom: "16px" }} gap={100}>
        <IconButton
          ...
          disabled={!selectedLayer || layers[0]?.id === selectedLayer} // Disable if no layer is selected or it's the top layer
        >
          <ArrowUpIcon />
        </IconButton>
